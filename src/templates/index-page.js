      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Protect your family’s future with a Will from MyTribe
              </h1>
            <p
              // className="is-size-3-mobile is-size-2-tablet is-size-1-widescreen"
              style={{
                    ...
                    <Grid item xs={12} className="grid-content icon-content">
                      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <p style={{
                          ...
                          Simply select the <Link style={{ fontWeight: '500' }} to='/packages' target='_blank'>Package</Link> with the right Will for you, then set the time and place for your meeting.
                            </p></div></Grid>
                  </Grid>
                </Grid>
                <Grid item xs={12} sm={3} >
                    ...
                    <Grid item xs={12} className="grid-content icon-content">
                      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <p style={{
                          ...
                          fontSize: '1.125rem',
                          lineHeight: '1.5',
                        }}>One of our expert lawyers comes to you, explains tailored estate planning documents that will protect your loved one’s future.
                            </p>  </div></Grid>
                  </Grid>
                </Grid>
                <Grid item xs={12} sm={3}>
                  <Grid container spacing={12}>
                    ...
                    <Grid item xs={12} className="grid-content icon-content">
                      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        }}>The documents will be finalised on the spot or within 7 days of the meeting. </p></div></Grid>
