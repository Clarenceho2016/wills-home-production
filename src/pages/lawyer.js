                        ...
                        <Grid item xs={12} sm={12} style={{ marginLeft: '1em', marginRight: '1em' }}>
                            <div style={{
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" style={{ height: '180px' }} viewBox="80 360 200 100">
                                    ...
                                    <g xmlns="http://www.w3.org/2000/svg">
                                        <circle fill="#3353B6" cx="197.08" cy="406.161" r="21" />
                        ...
                        <Grid item xs={12} sm={12} style={{ marginLeft: '1em', marginRight: '1em' }} >
                            <div style={{
                                ...
                                <svg version="1.1" id="layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="30 240 90 100"
                                    ...
                                    <g xmlns="http://www.w3.org/2000/svg">
                                        <path fill="#1D3285" d="M102.875,294.829h-58c-1.657,0-3-1.344-3-3v-26c0-1.657,1.343-3,3-3h58c1.657,0,3,1.343,3,3v26    C105.875,293.485,104.532,294.829,102.875,294.829z" />
                                        ...
                                        <polygon fill="#7598D9" points="69.875,296.58 70.83,298.58 69.875,300.58 71.875,299.625 73.875,300.58 72.919,298.58     73.875,296.58 71.875,297.536   " />
                                        <polygon fill="#7598D9" points="73.875,306.581 74.83,308.581 73.875,310.581 75.875,309.626 77.875,310.581 76.919,308.581     77.875,306.581 75.875,307.537   " />
                                        <polygon fill="#7598D9" points="101.875,316.582 102.83,318.582 101.875,320.582 103.875,319.627 105.875,320.582     104.919,318.582 105.875,316.582 103.875,317.538   " />
                                        <polygon fill="#7598D9" points="65.874,321.583 66.829,323.583 65.874,325.583 67.874,324.628 69.874,325.583 68.919,323.583     69.874,321.583 67.874,322.538   " />
                                    </g>
